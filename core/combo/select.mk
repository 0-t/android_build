...
$(combo_target)GLOBAL_CFLAGS := -fstrict-aliasing -Wstrict-aliasing -Wno-error=strict-aliasing -fno-exceptions -Wno-multichar -Wno-error=unused-parameter -Wno-unused-parameter -Wno-error=unused-but-set-variable -Wno-unused-but-set-variable
$(combo_target)RELEASE_CFLAGS := -O3 -g -fstrict-aliasing -Wstrict-aliasing -Wno-error=strict-aliasing -fno-tree-vectorize -fno-inline-functions -fno-unswitch-loops -fgcse-after-reload -fno-ipa-cp-clone -fno-vect-cost-model -Wno-error=unused-parameter -Wno-error=unused-but-set-variable -Wno-unused-but-set-variable
